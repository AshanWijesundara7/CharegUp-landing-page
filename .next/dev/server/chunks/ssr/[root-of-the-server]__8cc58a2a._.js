...
;
const metadata = {
    title: "ChargeUp - Power Up Anywhere",
    description: "Join the peer-to-peer ecosystem connecting EV drivers with private charging hosts. Secure, reliable, and community-driven.",
    generator: "v0.app",
    icons: {
        icon: [
            {
